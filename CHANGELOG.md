...
- Enhancement: Changed the `scs update` and `scs revert` commands so that they fail if Secure Credential Manager is not enabled. [#22](https://github.com/zowe/zowe-cli-scs-plugin/issues/22)
